...
(直接将代码贴到这里会导致`GitHub Pages failed to build your site`   😂)
...
调用智能合约就和 [从零开始编写智能合约-使用truffle套件](https://yinhui1984.github.io/从零开始编写智能合约-使用truffle套件/#7-demoapp调用合约)中的一样了, 可以跳转到那里进行参考
