---
title: "EVM"
date: 2022-10-06T09:14:06+08:00
draft: false
author: yinhui
...
>  一个相反的例子的浮点数, [用C或者C++随意写关于浮点数计算的代码并且期望它们能够在不同的编译器或者不同架构的机器上得到完全一致的结果是非常非常天真的。](https://www.sohu.com/a/116680763_466876) EVM上的Solidity也用同样的问题, 所以其干脆是[不支持浮点数](https://ethereum.stackexchange.com/questions/52962/usage-of-float-numbers-in-smart-contract/58751#58751)的.
